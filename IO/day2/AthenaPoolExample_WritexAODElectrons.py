...
streamCA = OutputStreamCfg( flags, streamName, disableEventTag = True,
                            ItemList = [ "ExampleTrackContainer#MyTracks", 
                                ...
                                "xAOD::ExampleElectronAuxContainer#TestContainerAux.decor1",
                                "xAOD::ExampleElectronAuxContainer#TestContainerAux.decor_float",
                                "xAOD::ExampleElectronAuxContainer#TestContainerAux.decor_longdouble",
                                "xAOD::ExampleElectronAuxContainer#TestContainerAux.decor_fatima"] )

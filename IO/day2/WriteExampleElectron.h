...
class WriteExampleElectron : public AthReentrantAlgorithm {
 ...
 public:
  ...
  // FATIMA's DECORATOR
  SG::WriteDecorHandleKey<xAOD::ExampleElectronContainer> decor_fatima{
      this, "ExampleElectronContainerDecorKeyInt", "TestContainer.decor_int",
      "decorator for int key"};
